...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672293455
...
cp %{_builddir}/nose-timer-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-nose_timer/218d8eca50e1cca1d8c154b6e3ff8096a06d5927 || :
